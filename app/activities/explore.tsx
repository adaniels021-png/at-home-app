...
const styles = StyleSheet.create({
  ...
  exploreHero: { minHeight: 120, borderRadius: 27, backgroundColor: '#7138DF', padding: 19, flexDirection: 'row', alignItems: 'center', gap: 13, overflow: 'hidden' }, headerIcon: { width: 54, height: 54, borderRadius: 19, backgroundColor: '#FFFFFF1F', alignItems: 'center', justifyContent: 'center' }, headerText: { flex: 1 }, title: { color: '#FFFFFF', fontSize: 27, fontWeight: '900', letterSpacing: -0.4 }, subtitle: { color: '#EEE6FF', fontSize: 14, fontWeight: '600', marginTop: 4 }, sparkle: { position: 'absolute', color: '#E8DCFF', fontSize: 26, right: 22, top: 14 },
